...
create table alarm (
	...
	memberIdxWho		int not null,				/* 알람 발생자 */
	alarmType			varchar(50) not null,		/* 알람 타입(채팅, 댓글, 토론, 문의답글) */
	alarmTypeIdx		varchar(50),				/* 각 타입에 해당하는 idx(채팅은 chat테이블의 idx, 댓글은 boardIdx, 답글은 serviceIdx) */
