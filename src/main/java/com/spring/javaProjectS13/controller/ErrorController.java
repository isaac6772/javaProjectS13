...
public class ErrorController {
	...
	// JSP페이지에서 에러발생시 공사중화면으로 보내어 보여주는 폼(jsp파일에서 처리하게 되면 이곳에서는 처리할 필요가없다.)
	...
	public String errorMessage1Post() {
		return "errorPage/errorMessage1";
	}
	...
	public String error500CheckGet(HttpSession session) {
		...
		System.out.println("length : " + mid.length());
		return "errorPage/errorMain";
	}
